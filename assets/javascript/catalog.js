...
function loadRegions(page, element) {
	...
	$.getJSON('https://rogueathletic.github.io/caldera-catalog-2020/assets/pages/'+page+'-regions.json').
		done(function(data) {
...
function setPreview(view) {
	...
	var previewWidth = 112,
		previewHeight = 73,
		previewSrc = 'https://rogueathletic.github.io/caldera-catalog-2020/assets/pages/preview.jpg',
